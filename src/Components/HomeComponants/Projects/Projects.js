...
const Projects = () => {
    return (
        <div className='w-11/12 mx-auto my-5 lg:my-20 text-white'>
            <h1 className='text-5xl font-semibold text-secondary mb-8 font-caveat'>Projects I have Build<span className='text-primary'>_</span></h1>
            ...
            <div className='lg:flex items-center justify-center mb-20'>
                ...
                <div className='text-start lg:text-end w-full lg:w-2/4'>
                    <h2 className='text-4xl text-secondary font-semibold font-caveat'>Dealogic</h2>
                    ...
                    <div className='p-3 rounded-lg z-10 lg:-ml-20 bg-[#081a3b]'>
                        <h4 className='text-primary text-2xl font-caveat'>Features_</h4>
                        <p>
            ...
            <div className='flex flex-col-reverse lg:flex-row items-center justify-center mb-20'>
                <div className='text-start w-full lg:w-2/4 z-10'>
                    <h2 className='text-4xl font-semibold text-secondary font-caveat'>Laura Jane</h2>
            ...
            <div className='lg:flex items-center justify-center'>
                ...
                <div className='text-end w-full lg:w-2/4'>
                    <h2 className='text-4xl font-semibold text-secondary font-caveat'>CareerEdu</h2>
                    <h4 className='my-5 text-lg font-semibold font-chivo'>
