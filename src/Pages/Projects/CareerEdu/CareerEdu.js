...
const CareerEdu = () => {
    return (
        <div className='w-10/12 lg:w-lg mx-auto mt-20 lg:mt-32'>
            {/* Name and Short Description */}
            <h2 className='text-3xl lg:text-4xl text-secondary font-semibold font-bigshoulder hover:text-primary'>CareerEdu</h2>
